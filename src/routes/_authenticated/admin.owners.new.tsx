...
export const Route = createFileRoute("/_authenticated/admin/owners/new")({
...
function NewOwnerPage() {
  ...
  const [form, setForm] = useState<any>({
    email: "", full_name: "", phone: "", nationality: "", language: "ar", shop_id: "", notes: "",
  });
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      <div><Link to="/admin/owners" className="text-xs text-muted-foreground hover:underline">← Owners</Link><h1 className="font-display text-3xl">Invite Owner</h1></div>
