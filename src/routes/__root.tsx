...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover Saudi Arabia's best barbers, browse their portfolios, and book your next cut in one tap." },
      { property: "og:description", content: "Discover Saudi Arabia's best barbers, browse their portfolios, and book your next cut in one tap." },
      { name: "twitter:description", content: "Discover Saudi Arabia's best barbers, browse their portfolios, and book your next cut in one tap." },
