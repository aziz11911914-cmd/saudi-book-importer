    ...
    translation: {
      ...
      barber: {
        ...
        dashboard: {
          ...
          emptyToday: "No bookings today.",
          emptyUpcoming: "No upcoming appointments.",
          viewAll: "View all",
        },
        bookingsPage: {
          title: "Bookings",
          filters: { today: "Today", upcoming: "Upcoming", completed: "Completed", cancelled: "Cancelled" },
        },
        actions: { complete: "Complete", cancel: "Cancel", noShow: "No-show", edit: "Edit", save: "Save" },
        days: { sun: "Sun", mon: "Mon", tue: "Tue", wed: "Wed", thu: "Thu", fri: "Fri", sat: "Sat" },
        settings: {
          title: "Settings",
          subtitle: "Configure working days, hours, break, and appointment duration.",
          durationTitle: "Appointment duration",
          durationLabel: "Duration",
          hoursTitle: "Working days & hours",
          off: "Off",
          open: "Open",
          close: "Close",
